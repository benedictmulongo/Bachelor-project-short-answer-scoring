...
""""
Author = Sujit Pal
Repository = https://github.com/sujitpal

Comments = take a long time to converge the time complexity is very high 
Must be updated to be more effective and valuable

Updated to Python 3 and bug fixing by Ben
"""
    ...
    if len(synsets_1) == 0 or len(synsets_2) == 0:
        ...
        for synset_1 in synsets_1:
            for synset_2 in synsets_2:
               ...
               #print("Syn 1 = ", synset_1,"Syn 2 = ", synset_2)
               #print("sim = ", sim)
               if sim == None:
                   sim = -1
               if sim > max_sim:
...
def sentences_similarity(sentence_1, sentence_2, info_content_norm):
    """
...
#     print(word_pair[0], " ", word_pair[1], " ",word_pair[2]," ", word_similarity(word_pair[0], word_pair[1]))
# 
# sentence_pairs = [
